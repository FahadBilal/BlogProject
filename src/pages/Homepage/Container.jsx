...
function Container() {
  return (
    <div className='sm:px-6 mb-20 '>
      ...
      <button className='border text-[16px] border-gray-light border-opacity-50 text-black dark:text-white text-opacity-50 px-3 py-2 rounded-md'>View All Post</button>
      </div>
    </div>
  )
}
