...
function Form() {
  return (
    <div>
      <h1 className="text-black dark:text-white text-[36px] font-bold font-sans text-center lg:text-left ">
        Get In Touch{" "}
      </h1>
      <p className="mt-2 text-black dark:text-white text-opacity-90 font-sans text-center lg:text-left ">
