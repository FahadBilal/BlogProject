  ...
  return (
    <div className='mt-16 sm:px-6 px-2 mb-10'>
      ...
      <div className='flex items-center gap-2'>
        ...
        <p className='text-black dark:text-white font-sans font-semibold text-[16px]'>Jonathan Doe</p>
        <p className='text-dark-gray dark:text-white font-sans  text-[16px]'>Collaborator & Editor</p>
        </div>
      </div>
      <p className='text-center text-[16px] text-[#3B3C4A] dark:text-white '>Meet Jonathan Doe, a passionate writer and blogger with a love for technology and travel. Jonathan holds a degree in Computer Science and has spent years working in the tech industry, gaining a deep understanding of the impact technology has on our lives.</p>
